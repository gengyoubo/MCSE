...
import github.com.gengyoubo.Minecraft_Science.Block.entity.ChemicalReactionTablefinaltypeBlockEntity;
...
public class MCSEBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<?>> CRTF = register("crtf", ModEventSubscriber_Block.CRTF, ChemicalReactionTablefinaltypeBlockEntity::new);
